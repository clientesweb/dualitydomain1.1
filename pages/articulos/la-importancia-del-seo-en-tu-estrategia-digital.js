  ...
  return (
    <>
      <Head>
        ...
        <link
          rel="canonical"
          href="https://www.dualitydomain.com/articulos/la-importancia-del-seo-en-tu-estrategia-digital"
        />
        ...
        <meta
          property="og:url"
          content="https://www.dualitydomain.com/articulos/la-importancia-del-seo-en-tu-estrategia-digital"
        />
        ...
        <script
          ...
          dangerouslySetInnerHTML={{
            __html: JSON.stringify({
              ...
              "@type": "BlogPosting",
              "@id": "https://www.dualitydomain.com/articulos/la-importancia-del-seo-en-tu-estrategia-digital#article",
              ...
              mainEntityOfPage: {
                "@type": "WebPage",
                "@id": "https://www.dualitydomain.com/articulos/la-importancia-del-seo-en-tu-estrategia-digital",
              },
              articleSection: "SEO",
            ...
            <motion.header variants={fadeIn("up", "tween", 0.2, 1)} className="text-center mb-12">
              ...
              <div className="flex flex-col md:flex-row items-center justify-center gap-4 mb-8">
                ...
                <div className="text-secondary-white text-sm">
                  <time dateTime="2024-07-10">{article.date}</time>
                </div>
              </div>
            </motion.header>
