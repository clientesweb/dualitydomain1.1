...
const BlogPostPage = () => {
      ...
      if (postId) {
        ...
        if (!foundPost) {
          ...
          if (alternativePost) {
            ...
            // Update the URL silently to the correct ID without causing a reload
            const url = `/blog/${alternativePost.id}`
  ...
  // Add this code before the return statement that checks for post
  if (id && !post) {
    return (
