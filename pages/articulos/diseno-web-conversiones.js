  ...
  return (
    <>
      ...
      <div className="bg-primary-black overflow-hidden min-h-screen">
        ...
        <main className="relative z-10 w-full bg-primary-black min-h-screen">
          <article className={`${styles.paddings} relative z-20 bg-primary-black`}>
            ...
            <motion.div
              ...
              className={`${styles.innerWidth} mx-auto flex flex-col relative z-30 bg-primary-black md:bg-transparent`}
            >
              ...
              <motion.section
                ...
                className="max-w-4xl mx-auto relative z-40 px-4 sm:px-0 bg-primary-black md:bg-transparent rounded-lg md:rounded-none"
              >
                <div
                  className="blog-content prose prose-invert max-w-none text-white leading-relaxed text-sm sm:text-base p-4 md:p-0 bg-primary-black md:bg-transparent rounded-lg md:rounded-none"
